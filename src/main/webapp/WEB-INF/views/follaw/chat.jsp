            ...
            <div class="twm-jobs-grid-style1">
                <div class="twm-mid-content">
                    <p class="twm-job-title roomName">
                        ...
                        <button type="submit" onclick="joinRoom()" class="site-button" style="position: relative; left: 340px;" class="inBtn">참가</button>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-12 m-b30">
            ...
            <div class="twm-jobs-grid-style1">
                ...
                <div class="twm-right-content">
                    <button type="submit" class="site-button" style="position: relative; left: 340px;">참가</button>
                </div>
            </div>
            ...
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                                 <div class="twm-candidates-grid-style1 mb-5" style="height: 270px; width: 500px; margin: 0 auto;">
                                     <br/>
                                        <form action="candidate_chat" method="get">
                                            <br/>
                                            <input type="text" class="form-control" placeholder="방 이름을 작성하세요." style="text-align: center;" name="roomName" id="roomName">
                                            <br/>
                                            <button type="submit" class="site-button" style="position: relative; left: 360px; width: auto;" id="chatRoomNameBtn">생성</button>
                                        </form>
                                     </div>
                            </div>    
                    </div>
