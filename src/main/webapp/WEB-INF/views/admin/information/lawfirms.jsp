                    ...
                    <div class="container" id="box">
                            ...
                            <div class="twm-D_table table-responsive">
                                <table id="jobs_bookmark_table" class="table table-bordered twm-candidate-save-job-list-wrap">
                                    ...
                                    <tbody>
                                        <c:forEach items="${lawfirmsList}" var="lawfirms">
                                                <tr>
                                                    <td>
                                                        <div>${lawfirms.lawfirm_idx}</div>
                                                    </td>

                                                    <td>
                                                        <div>${lawfirms.lawfirm_city}</div>
                                                    </td>

                                                    <td>
                                                        <div><a class="title" href="lawfirms_view?lawfirm_idx=${lawfirms.lawfirm_idx}" style="color: #1967d2;">${lawfirms.lawfirm_name}</a></div>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                    </tbody>
                                </table>
                                <a class="site-button" href="lawfirms_insert">법률사무소 등록</a>
                            </div>                             
                    </div>
                </div>                                    
            </div>
